...
namespace MutexManager
{
    ...
    static internal class ProgramInfo
    {
        static internal string AssemblyGuid
        {
            get
            {
                var attrs = Assembly.GetExecutingAssembly().GetCustomAttributes(typeof(System.Runtime.InteropServices.GuidAttribute), false);
                //object[] attributes = Assembly.GetEntryAssembly().GetCustomAttributes(typeof(System.Runtime.InteropServices.GuidAttribute), false);
                if (attrs.Length == 0)
                {
                    return String.Empty;
                }
                return ((System.Runtime.InteropServices.GuidAttribute)attrs[0]).Value;
            }
        }
